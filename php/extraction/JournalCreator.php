...
//			fwrite($fh, $systemName);
			...
			$prodFilnavn = "\t\t<FIL>\n\t\t\t<PI.FILNAVN>JOURNAL.XML</PI.FILNAVN>\n\t\t</FIL>\n";
	...
	function jpXML ($jp, $tabs) {
		...
		$xmlString .= $tabs . "<JP.POSTNR>". $jp['JP_POSTNR'] ."</JP.POSTNR>\n";
